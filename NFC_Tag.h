...
#define sEE_LONG_TIMEOUT         ((uint32_t)(10 * 0x1000))
...
#define sEE_I2C_DR_Address               ((u32)0x40005410)
#define sEE_USE_DMA
...
typedef enum {RIGHT = 0, ERR_No1 = 1, ERR_No2 = 2, ERR_No3 = 3, ERR_No4 = 4, ERR_No5 = 5, ERR_No6 = 6, ERR_No7 = 7} EE_Status;

void nfcEE_Init(void);
